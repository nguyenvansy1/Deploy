...
public interface IEventRepository extends JpaRepository<Event,Long> {
    ...
    Integer[][] getDataEvent(@Param("year") Integer year);
    ...
    @Query(value = "select * from events where event_customer_id = :id", nativeQuery = true)
    List<Event> getListEventByCustomer(@Param("id") Long id);
